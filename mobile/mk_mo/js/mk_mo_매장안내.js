    ...
    var template = {
        ...
        makeInfoTemplate : function(data) {
            return '<div class="info">' +
                        ...
                        '</span>' +
                        '<span class="hc_inline">' +
                            '<button type="button" class="togglePhoto" data-id="hcStoreWrap'+data.id+'">'+                    
                                '<img style="display:block !important" src="http://kcompony7.jpg3.kr/web/hncok/img/icon/icon_camera.svg" alt="매장사진" />'+
                            '</button>'+
                            '<button type="button" class="toggleMap" data-id="hcStoreWrap'+data.id+'">'+
                                '<img style="display:block !important" src="http://kcompony7.jpg3.kr/web/hncok/img/icon/icon_map.svg" alt="매장지도" />'+
                            '</button>'+
                        '</span>' +
                    '</div>';
        },
        makeMapTemplate : function(id) {
            return '<div class="map"><div id="shop'+id+'" style="height:400px"></div></div>';
