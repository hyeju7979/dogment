...
var HcTimeLimit = (function() {
    ...
    var action = {
        ...
        isExist : function() {
            return jQuery('div.timesaleItem').length ? true : false;
        }
        ...
        initFullPage : function() {
            jQuery('#fullpage').fullpage({        
                ...
                afterLoad : function(origin, destination) {
                     ...
                     AnimateAction.handler.action(destination,'animated-fadeInDown','animate__fadeInDown');
                     AnimateAction.handler.action(destination,'animated-fadeInLeft','animate__fadeInLeft');
                     AnimateAction.handler.action(destination,'animated-fadeInRight','animate__fadeInRight');
                }
            });
        },
        isExist : function() {
...
var HeaderMenuOpen = (function(){
	...
	var action = {
        fullPageSetMouseWheelScrolling : function(boolean) {
            if(HcFullPage.handler.isExist()) {
                HcFullPage.handler.setMouseWheelScrolling(boolean);
            }
        },
